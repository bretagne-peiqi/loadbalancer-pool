...
type FakeLoadBalancers struct {
	Fake *FakeLbpoolV1alpha1
	ns   string
}

var loadbalancersResource = schema.GroupVersionResource{Group: "lbpool.k8s.io", Version: "v1alpha1", Resource: "loadbalancers"}

var loadbalancersKind = schema.GroupVersionKind{Group: "lbpool.k8s.io", Version: "v1alpha1", Kind: "LoadBalancer"}

...
import (
	...
	versioned "github.com/bretagne-peiqi/loadbalancer-pool/pkg/client/clientset/versioned"
	internalinterfaces "github.com/bretagne-peiqi/loadbalancer-pool/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/bretagne-peiqi/loadbalancer-pool/pkg/client/listers/lbpool/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LbpoolV1alpha1().LoadBalancers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LbpoolV1alpha1().LoadBalancers(namespace).Watch(options)
			},
		},
		&lbpoolv1alpha1.LoadBalancer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *loadBalancerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lbpoolv1alpha1.LoadBalancer{}, f.defaultInformer)
}
